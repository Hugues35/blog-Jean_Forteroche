            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="summary-block">
                        ...
                        <ul class="chapters-summary">
                            <li><a class="chapter-link" href="./chapter1" title="Chapitre 1"><i class="fas fa-link"></i>Chapitre 1 – Grande terre</a></li>
                            <li><a class="chapter-link" href="./chapter2" title="Chapitre 2"><i class="fas fa-link"></i>Chapitre 2 – Kodiak la sauvage</a></li>
                            <li><a class="chapter-link" href="./chapter3" title="Chapitre 3"><i class="fas fa-link"></i>Chapitre 3 – Les filles de l’air</a></li>
                            <li><a class="chapter-link" href="./chapter4" title="Chapitre 4"><i class="fas fa-link"></i>Chapitre 4 – La dernière frontière</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="chapterextract-block">
                        ...
                        <p class="chapter-com-message"><i class="far fa-comment"></i><?= $lastMessage['message']?></p>
                        ...
                        <div class="mt-50"></div>                        
                        <p class="chapter-com-link"><a href="./chapter1"><i class="far fa-hand-point-right"></i>Les autres commentaires...</a></p>
                    </div>
                </div>
                <div class="col-md-6">
                     <div class="chapterextract-block">
